<template>
    <a-form-item 
        ...
        :class="getClass()"
    >
        <a-radio-group :name="fieldOptions.fieldName"
            ...
            <a-radio v-for="item in options"
                :key="item[fieldOptions.idProperty || 'id']"
                :value="item[fieldOptions.valueProperty || 'id']">{{item[fieldOptions.textProperty || 'name']}}</a-radio>
        </a-radio-group>
